...
define( 'SAMA_GATEWAY_VERSION', $plugin_data['version'] );
...
add_action(
	...
	function() {
		...
		$extend_core = new Sama_Gateway_Extend_Woo_Core();
		$extend_core->init();

		add_action(
			'woocommerce_blocks_checkout_block_registration',
			function( $integration_registry ) {
				$integration_registry->register( new Sama_Gateway_Blocks_Integration() );
			}
		);
	}
);
